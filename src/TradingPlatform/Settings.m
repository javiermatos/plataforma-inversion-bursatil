...
classdef Settings < handle
    ...
    properties (Constant = true)
        ...
        BothSets                = 2
        AllValues               = 3
        TargetSet               = Settings.TestSet
        
        LongPositions           = 0
        ShortPositions          = 1
        LongShortPositions      = 2
        AllowedPositions        = Settings.LongShortPositions
        
        Split                   = 0.5 % Split between training and test sets
        TrainingSetInterval     = @(n) [1 floor(n*Settings.Split)];
        TestSetInterval         = @(n) [floor(n*Settings.Split)+1 n];
        ...
        RelativeStrengthIndexCrossing = createStruct(Settings.RelativeStrengthIndex, ...
                                    'CMode', 'e', ...
                                    'CSamples', 10 ...
                                    );
        ...
        StochasticCrossing      = createStruct(Settings.Stochastic ...
                                    );
        
        StochasticStateMachine  = createStruct(Settings.Stochastic ...
                                    );
        ...
        MomentumCrossing        = createStruct(Settings.Momentum, ...
                                    'Mode', 'e', ...
                                    'Samples', 3 ...
                                    );
        ...
        LastNTrends             = createStruct(Settings.LastN ...
                                    );

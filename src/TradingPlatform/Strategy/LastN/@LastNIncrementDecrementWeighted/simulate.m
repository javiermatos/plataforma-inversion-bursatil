...
for i = 1:samples
    nRisingTrend = nRisingTrend + [zeros(1,i) risingTrend(1:end-i+1)*weight(samples-i+1)];
    nFallingTrend = nFallingTrend + [zeros(1,i) fallingTrend(1:end-i+1)*weight(samples-i+1)];
end

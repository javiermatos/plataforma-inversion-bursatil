...
function signalFragment = computeSignalFragment(te, startIndex, endIndex, fragmentNumber)
...
% Signal calculation
signalFragment(serieFragment>(movingAverage*(1+riseThreshold))) = 1;    % Buy signal
signalFragment(serieFragment<(movingAverage*(1-fallThreshold))) = -1;   % Sell signal

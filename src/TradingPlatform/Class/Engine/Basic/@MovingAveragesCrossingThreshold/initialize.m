...
function te = initialize(fts, modeDomain, leadLagDomain, riseFallThresholdDomain)
...
% Full
te = te.exhaustiveOptimizer('Mode',modeDomain,'LeadLag',leadLagPairs(leadLagDomain),'RiseThreshold',riseFallThresholdDomain,'FallThreshold',riseFallThresholdDomain);
